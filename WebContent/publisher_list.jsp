...
<sql:setDataSource
    ...
    <sql:query var="listpublisher"   dataSource="${myDS}">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <c:forEach var="user" items="${listpublisher.rows}"> 
                <tr>
                    <td><c:out value="${user.publisher_id}" /></td>
                    <td><c:out value="${user.publisher_name}" /></td>
                    <td><c:out value="${user.publisher_address}" /></td>
                </tr>
            	</c:forEach>
                </tbody>
              </table>
